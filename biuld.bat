...
C:\Users\Administrator\go\go1.17.5\bin\go.exe build -o C:\Users\Administrator\Desktop\project\github\instagram_project\bin\short_link makemoney/routine/short_link
