...
func (this *IdeaPool) GetNoRisk(busy bool, used bool) *Proxy {
	return this.get()
}

func (this *IdeaPool) Get(id string) *Proxy {
	return this.get()
}

func (this *IdeaPool) Black(proxy *Proxy, _type BlackType) {

}
func (this *IdeaPool) Remove(proxy *Proxy) {

}

func (this *IdeaPool) Dumps() {
