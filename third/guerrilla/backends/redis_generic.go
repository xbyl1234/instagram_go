...
func init() {
	RedisDialer = func(network, address string, password string, options ...RedisDialOption) (RedisConn, error) {
...
type redisDial func(network, address string, password string, options ...RedisDialOption) (RedisConn, error)
